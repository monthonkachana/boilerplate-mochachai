...
suite('Unit Tests', function () {
  ...
  suite('Equality', function () {
    ...
    test('#strictEqual, #notStrictEqual', function () {
      ...
      assert.strictEqual(6 * '2', 12); // เพราะ 6 * array ที่ 2 เท่กับ 12 จึง equal
  ...
  suite('Comparisons', function () {
    ...
    //.isAbove() ใช้ในการตรวจสอบว่าค่าที่กำหนดมากกว่าค่าอื่น ๆ ในขณะที่ .isAtMost() ใช้ในการตรวจสอบว่าค่าที่กำหนดน้อยกว่าหรือเท่ากับค่าอื่น ๆ
